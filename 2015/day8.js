...
const input = `"azlgxdbljwygyttzkfwuxv"
...
function part1(arr) {
    let s = 0
    for (const a of arr) {
        s +=String.raw`${a}`.length
        s -= String(a).length
        console.log(String.raw`${a}`, String(a))
    }
    return s
}


// patch String.prototype.split to use raw string

x = part1(sample.split('\n'))
console.log(x)